...
var AuthServiceController = function () {
    ...
    var AuthServiceController = _classThis = /** @class */ (function () {
        function AuthServiceController_1(authServiceService) {
            this.authServiceService = (__runInitializers(this, _instanceExtraInitializers), authServiceService);
        }
        AuthServiceController_1.prototype.getHello = function () {
            return this.authServiceService.getHello();
        };
        return AuthServiceController_1;
    }());
    __setFunctionName(_classThis, "AuthServiceController");
    (function () {
        ...
        AuthServiceController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AuthServiceController = _classThis;
}();
